...
public class Y12 implements cz.syntea.xdef.component.XComponent{
  public java.util.List<Y12_B> listOfB() {return _B;}
  public void addB(Y12_B x) {
    if (x!=null) _B.add(x);
  }
//<editor-fold defaultstate="collapsed" desc="XComponent interface">
  ...
  public Y12() {}
  public Y12(cz.syntea.xdef.component.XComponent p,
  ...
  public Y12(cz.syntea.xdef.component.XComponent p, cz.syntea.xdef.proc.XXNode xx){
  ...
  public cz.syntea.xdef.component.XComponent xCreateXChild(cz.syntea.xdef.proc.XXNode xx)
    {return new test.xdef.component.Y12_B(this, xx);}
  @Override
  public void xAddXChild(cz.syntea.xdef.component.XComponent xc) {
    xc.xSetNodeIndex(XD_ndx++);
    listOfB().add((test.xdef.component.Y12_B) xc); //Y12#A/B
  }
  @Override
