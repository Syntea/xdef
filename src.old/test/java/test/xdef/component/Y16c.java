...
public class Y16c implements cz.syntea.xdef.component.XComponent{
...
//<editor-fold defaultstate="collapsed" desc="XComponent interface">
  ...
  public java.util.List<cz.syntea.xdef.component.XComponent> xGetNodeList() {
    ...
    cz.syntea.xdef.component.XComponentUtil.addXC(a, listOfd());
    return XD_List = a;
  }
  public Y16c() {}
  public Y16c(cz.syntea.xdef.component.XComponent p,
  ...
  public Y16c(cz.syntea.xdef.component.XComponent p, cz.syntea.xdef.proc.XXNode xx){
    org.w3c.dom.Element el=xx.getElement();
    XD_NodeName=el.getNodeName(); XD_NamespaceURI=el.getNamespaceURI();
    XD_XPos=xx.getXPos();
    XD_Model=xx.getXMElement().getXDPosition();
    XD_Object = (XD_Parent=p)!=null ? p.xGetObject() : null;
    if (!"0DB888D9E2B8EB4E92BB2517397AA71C".equals(
