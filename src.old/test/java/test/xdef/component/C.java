...
public class C extends test.xdef.TestXComponents_C implements cz.syntea.xdef.component.XComponent{
...
//<editor-fold defaultstate="collapsed" desc="XComponent interface">
  ...
  public java.util.List<cz.syntea.xdef.component.XComponent> xGetNodeList() {
    ...
    cz.syntea.xdef.component.XComponentUtil.addXC(a, listOfStreet());
    return XD_List = a;
  }
  public C() {}
...
// </editor-fold>
public static class Street implements cz.syntea.xdef.component.XComponent{
  public String getName() {return _Name;}
...
//<editor-fold defaultstate="collapsed" desc="XComponent interface">
  ...
  public java.util.List<cz.syntea.xdef.component.XComponent> xGetNodeList() {
    java.util.ArrayList<cz.syntea.xdef.component.XComponent> a =
      new java.util.ArrayList<cz.syntea.xdef.component.XComponent>();
    cz.syntea.xdef.component.XComponentUtil.addXC(a, listOfHouse());
    return XD_List = a;
  }
  public Street() {}
  public Street(cz.syntea.xdef.component.XComponent p,
    String name, String ns, String xPos, String XDPos) {
    XD_NodeName=name; XD_NamespaceURI=ns;
    XD_XPos=xPos;
    XD_Model=XDPos;
  ...
  public Street(cz.syntea.xdef.component.XComponent p, cz.syntea.xdef.proc.XXNode xx){
    org.w3c.dom.Element el=xx.getElement();
    XD_NodeName=el.getNodeName(); XD_NamespaceURI=el.getNamespaceURI();
    XD_XPos=xx.getXPos();
    XD_Model=xx.getXMElement().getXDPosition();
