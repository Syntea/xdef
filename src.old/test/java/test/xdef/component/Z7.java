...
public class Z7 implements cz.syntea.xdef.component.XComponent{
  public cz.syntea.xdef.sys.SDatetime getDatumRozhodnuti() {return _DatumRozhodnuti;}
  public java.util.Date dateOfDatumRozhodnuti() {
    return cz.syntea.xdef.sys.SDatetime.getDate(_DatumRozhodnuti);
  }
  public java.sql.Timestamp timestampOfDatumRozhodnuti() {
    return cz.syntea.xdef.sys.SDatetime.getTimestamp(_DatumRozhodnuti);
  }
  public java.util.Calendar calendarOfDatumRozhodnuti() {
    return cz.syntea.xdef.sys.SDatetime.getCalendar(_DatumRozhodnuti);
  }
  public String get$value() {return _$value;}
  public void setDatumRozhodnuti(cz.syntea.xdef.sys.SDatetime x) {_DatumRozhodnuti = x;}
  public void setDatumRozhodnuti(java.util.Date x) {
    _DatumRozhodnuti=x==null ? null : new cz.syntea.xdef.sys.SDatetime(x);
  }
...
//<editor-fold defaultstate="collapsed" desc="XComponent interface">
  ...
  public Z7() {}
  public Z7(cz.syntea.xdef.component.XComponent p,
  ...
  public Z7(cz.syntea.xdef.component.XComponent p, cz.syntea.xdef.proc.XXNode xx){
    org.w3c.dom.Element el=xx.getElement();
    XD_NodeName=el.getNodeName(); XD_NamespaceURI=el.getNamespaceURI();
    XD_XPos=xx.getXPos();
    XD_Model=xx.getXMElement().getXDPosition();
    XD_Object = (XD_Parent=p)!=null ? p.xGetObject() : null;
    if (!"7CA2F46CE71EE6F3638823023ECFCDF7".equals(
      xx.getXMElement().getDigest())) { //incompatible element model
      throw new cz.syntea.xdef.sys.SRuntimeException(
        cz.syntea.xdef.msg.XDEF.XDEF374);
    }
  }
  private cz.syntea.xdef.sys.SDatetime _DatumRozhodnuti;
