...
public class Y10 implements cz.syntea.xdef.component.XComponent{
...
//<editor-fold defaultstate="collapsed" desc="XComponent interface">
  ...
  public Y10() {}
  public Y10(cz.syntea.xdef.component.XComponent p,
  ...
  public Y10(cz.syntea.xdef.component.XComponent p, cz.syntea.xdef.proc.XXNode xx){
    org.w3c.dom.Element el=xx.getElement();
    XD_NodeName=el.getNodeName(); XD_NamespaceURI=el.getNamespaceURI();
    XD_XPos=xx.getXPos();
    XD_Model=xx.getXMElement().getXDPosition();
    XD_Object = (XD_Parent=p)!=null ? p.xGetObject() : null;
    if (!"42B1818BA0488B93B869A25CC59F39DB".equals(
  ...
  public void xSetAttr(cz.syntea.xdef.proc.XXNode xx,
    ...
    else setc(parseResult.getParsedValue().stringValue());
  }
  @Override
