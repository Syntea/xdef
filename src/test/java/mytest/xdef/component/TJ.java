...
public class TJ implements org.xdef.component.XComponent{
  public String getxmlns$jw() {return "http://www.w3.org/2005/xpath-functions";}
  public TJ.jw$number getjw$number() {return _jw$number;}
  public Integer jgetnumber(){return _jw$number==null?null:_jw$number.get$value();}
  public void setjw$number(TJ.jw$number x){_jw$number=x;}
  public void jsetnumber(Integer x){
    if(_jw$number==null)setjw$number(new TJ.jw$number());
...
//<editor-fold defaultstate="collapsed" desc="Implementation of XComponent interface">
  ...
  public TJ() {}
  public TJ(org.xdef.component.XComponent p,
  ...
  public TJ(org.xdef.component.XComponent p,org.xdef.proc.XXNode x){
    org.w3c.dom.Element el=x.getElement();
    XD_NodeName=el.getNodeName(); XD_NamespaceURI=el.getNamespaceURI();
    XD_XPos=x.getXPos();
    XD_Model=x.getXMElement().getXDPosition();
    XD_Object = (XD_Parent=p)!=null ? p.xGetObject() : null;
    if (!"ED69A7790424C4F41817FD2BCFC1AC86".equals(
      x.getXMElement().getDigest())) { //incompatible element model
      throw new org.xdef.sys.SRuntimeException(
        org.xdef.msg.XDEF.XDEF374);
    }
  }
  private TJ.jw$number _jw$number;
