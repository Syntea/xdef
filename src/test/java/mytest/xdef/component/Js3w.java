...
public class Js3w implements org.xdef.component.XComponent{
  ...
  public String jgeta_b(){return _jw$string==null?null:org.xdef.json.JsonUtil.jstringFromXML(_jw$string.get$value());}
  public void setjw$string(Js3w.jw$string x){_jw$string=x;}
  public void jseta_b(String x){
