...
public class XD implements org.xdef.component.XComponent{
  ...
  public void jseta$number(Number x){
    if(x==null) _js$number=null;
      ...
      if(_js$number==null) setjs$number(new XD.js$number());
      _js$number.set$value(x);
    }
  }
  public void setjs$number(XD.js$number x){
    _js$string=null;_js$number=null;_js$boolean=null;_js$null=null;
    _js$number=x;
    }
  public void jseta$boolean(Boolean x){
    if(x==null) _js$boolean=null;
      ...
      if(_js$boolean==null) setjs$boolean(new XD.js$boolean());
      _js$boolean.set$value(x);
    }
  }
  public void setjs$boolean(XD.js$boolean x){
    _js$string=null;_js$number=null;_js$boolean=null;_js$null=null;
    _js$boolean=x;
    }
  public void jseta$null(org.xdef.json.JNull x){
    if(_js$null==null)setjs$null(x==null?null:new XD.js$null());
  }
  public void setjs$null(XD.js$null x){
    _js$string=null;_js$number=null;_js$boolean=null;_js$null=null;
    _js$null=x;
    }
//<editor-fold defaultstate="collapsed" desc="Implementation of XComponent interface">
  ...
  public XD() {}
  public XD(org.xdef.component.XComponent p,
  ...
  public XD(org.xdef.component.XComponent p,org.xdef.proc.XXNode x){
  ...
  private XD.js$null _js$null;
  private XD.js$boolean _js$boolean;
  private XD.js$number _js$number;
  private XD.js$string _js$string;
  ...
  public org.xdef.component.XComponent xCreateXChild(
    ...
    if ("#json/js:map/$choice/js:null".equals(s))
      return new js$null(this, x);
    if ("#json/js:map/$choice/js:boolean".equals(s))
      return new js$boolean(this, x);
    if ("#json/js:map/$choice/js:number".equals(s))
      return new js$number(this, x);
    return new js$string(this, x); // #json/js:map/$choice/js:string
  }
  @Override
  public void xAddXChild(org.xdef.component.XComponent x){
    ...
    else if ("#json/js:map/$choice/js:boolean".equals(s))
      setjs$boolean((js$boolean)x);
    else if ("#json/js:map/$choice/js:number".equals(s))
      setjs$number((js$number)x);
    else
      setjs$string((js$string)x); //#json/js:map/$choice/js:string
  }
  @Override
...
//<editor-fold defaultstate="collapsed" desc="Implementation of XComponent interface">
  ...
  private int XD_Index = -1;
  private String XD_XPos;
  private String XD_Model="#json/js:map/$choice/js:null";
  @Override
  public void xSetText(org.xdef.proc.XXNode x,
    org.xdef.XDParseResult parseResult){}
  @Override
...
//<editor-fold defaultstate="collapsed" desc="Implementation of XComponent interface">
  ...
  public java.util.List<org.xdef.component.XComponent> xGetNodeList() {
    ...
    if (get$value() != null)
      org.xdef.component.XComponentUtil.addText(this,
        "#json/js:map/$choice/js:boolean/$text", a, get$value().toString(), _$$value);
    return a;
  }
  public js$boolean() {}
  ...
  private int XD_ndx;
  private String XD_XPos;
  private String XD_Model="#json/js:map/$choice/js:boolean";
  @Override
  public void xSetText(org.xdef.proc.XXNode x,
    org.xdef.XDParseResult parseResult){
    _$$value=(char) XD_ndx++;
...
//<editor-fold defaultstate="collapsed" desc="Implementation of XComponent interface">
  ...
  public java.util.List<org.xdef.component.XComponent> xGetNodeList() {
    ...
    if (get$value() != null)
      org.xdef.component.XComponentUtil.addText(this,
        "#json/js:map/$choice/js:number/$text", a, get$value().toString(), _$$value);
    return a;
  }
  public js$number() {}
  ...
  private int XD_ndx;
  private String XD_XPos;
  private String XD_Model="#json/js:map/$choice/js:number";
  @Override
  public void xSetText(org.xdef.proc.XXNode x,
    org.xdef.XDParseResult parseResult){
    _$$value=(char) XD_ndx++;
...
//<editor-fold defaultstate="collapsed" desc="Implementation of XComponent interface">
  ...
  public java.util.List<org.xdef.component.XComponent> xGetNodeList() {
    ...
    if (get$value() != null)
      org.xdef.component.XComponentUtil.addText(this,
        "#json/js:map/$choice/js:string/$text", a, get$value(), _$$value);
    return a;
  }
  public js$string() {}
  ...
  private int XD_ndx;
  private String XD_XPos;
  private String XD_Model="#json/js:map/$choice/js:string";
  @Override
  public void xSetText(org.xdef.proc.XXNode x,
    org.xdef.XDParseResult parseResult){
    _$$value=(char) XD_ndx++;
