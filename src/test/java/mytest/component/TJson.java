...
public class TJson implements org.xdef.component.XComponent{
  ...
  public void jsetstring(org.xdef.sys.SDatetime x){
    if(x==null) _jx$string=null;
    else {
      if(_jx$string==null) setjx$string(new TJson.jx$string());
      _jx$string.set$value(x);
    }
  }
  ...
  public void setjx$string(TJson.jx$string x){_jx$string=x;}
//<editor-fold defaultstate="collapsed" desc="Implementation of XComponent interface">
  ...
  public org.w3c.dom.Node toXml(org.w3c.dom.Document doc) {
    ...
    el.setAttributeNS(javax.xml.XMLConstants.XMLNS_ATTRIBUTE_NS_URI,
      "xmlns:jx", "http://www.w3.org/2005/xpath-functions");
  ...
  public java.util.List<org.xdef.component.XComponent> xGetNodeList() {
    ...
    org.xdef.component.XComponentUtil.addXC(a, getjx$string());
    return a;
  }
  public TJson() {}
  ...
  public TJson(org.xdef.component.XComponent p,org.xdef.proc.XXNode x){
    ...
    XD_Object = (XD_Parent=p)!=null ? p.xGetObject() : null;
    if (!"E41B94367516FF8E1AFB6095A7AE1F0B".equals(
      x.getXMElement().getDigest())) { //incompatible element model
      throw new org.xdef.sys.SRuntimeException(
        org.xdef.msg.XDEF.XDEF374);
    }
  }
  private TJson.jx$string _jx$string;
  ...
  private String XD_Model="#jw:json/jx:array";
  @Override
  ...
  public org.xdef.component.XComponent xCreateXChild(
    ...
    {return new jx$string(this, x);}
  @Override
  public void xAddXChild(org.xdef.component.XComponent x){
    x.xSetNodeIndex(XD_ndx++);
    setjx$string((jx$string) x); //#jw:json/jx:array/jx:string
  }
  @Override
  public void xSetAny(org.w3c.dom.Element el) {}
// </editor-fold>
public static class jx$string implements org.xdef.component.XComponent{
  public String getxmlns$jx() {return "http://www.w3.org/2005/xpath-functions";}
...
//<editor-fold defaultstate="collapsed" desc="Implementation of XComponent interface">
  ...
  public java.util.List<org.xdef.component.XComponent> xGetNodeList() {
    ...
    if (get$value() != null)
      org.xdef.component.XComponentUtil.addText(this,
        "#jw:json/jx:array/jx:string/$text", a, get$value().formatDate("y-MM-dd[Z]"), _$$value);
    return a;
  }
  public jx$string() {}
  public jx$string(org.xdef.component.XComponent p,
    String name, String ns, String xPos, String XDPos) {
    XD_NodeName=name; XD_NamespaceURI=ns;
    XD_XPos=xPos;
    XD_Model=XDPos;
  ...
  public jx$string(org.xdef.component.XComponent p,org.xdef.proc.XXNode x){
    org.w3c.dom.Element el=x.getElement();
    XD_NodeName=el.getNodeName(); XD_NamespaceURI=el.getNamespaceURI();
    XD_XPos=x.getXPos();
    XD_Model=x.getXMElement().getXDPosition();
    XD_Object = (XD_Parent=p)!=null ? p.xGetObject() : null;
    if (!"DBE8F476CFCCC191AF5861D9F5B7235B".equals(
      x.getXMElement().getDigest())) { //incompatible element model
      throw new org.xdef.sys.SRuntimeException(
        org.xdef.msg.XDEF.XDEF374);
    }
  ...
  public static final String XD_NAME="jx:string";
  private org.xdef.component.XComponent XD_Parent;
  private Object XD_Object;
  private String XD_NodeName = "jx:string";
  private String XD_NamespaceURI = "http://www.w3.org/2005/xpath-functions";
  private int XD_Index = -1;
  private int XD_ndx;
  private String XD_XPos;
  private String XD_Model="#jw:json/jx:array/jx:string";
  @Override
  public void xSetText(org.xdef.proc.XXNode x,
    org.xdef.XDParseResult parseResult){
    _$$value=(char) XD_ndx++;
