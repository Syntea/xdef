...
public class XAA implements org.xdef.component.XComponent{
  ...
  public void jseta$number(Number x){
    if(x==null) _jw$number=null;
      ...
      if(_jw$number==null) setjw$number(new XAA.jw$number());
      _jw$number.set$value(x);
    }
  }
  public void setjw$number(XAA.jw$number x){
    _jw$string=null;_jw$number=null;_jw$boolean=null;_jw$null=null;
    _jw$number=x;
    }
  public void jseta$boolean(Boolean x){
    if(x==null) _jw$boolean=null;
      ...
      if(_jw$boolean==null) setjw$boolean(new XAA.jw$boolean());
      _jw$boolean.set$value(x);
    }
  }
  public void setjw$boolean(XAA.jw$boolean x){
    _jw$string=null;_jw$number=null;_jw$boolean=null;_jw$null=null;
    _jw$boolean=x;
    }
  public void jseta$null(org.xdef.json.JNull x){
    if(_jw$null==null)setjw$null(x==null?null:new XAA.jw$null());
  }
  public void setjw$null(XAA.jw$null x){
    _jw$string=null;_jw$number=null;_jw$boolean=null;_jw$null=null;
    _jw$null=x;
    }
//<editor-fold defaultstate="collapsed" desc="Implementation of XComponent interface">
  ...
  private XAA.jw$null _jw$null;
  private XAA.jw$boolean _jw$boolean;
  private XAA.jw$number _jw$number;
  private XAA.jw$string _jw$string;
