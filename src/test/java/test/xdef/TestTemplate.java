...
"<xd:def xmlns:xd='" + XDEFNS + "' script='options noTrimText' root='a'>\n"+
"<a xd:script=\"template\"\n"+
"   a1=\"a1\">\n"+
"  <b>\n"+
"  <c a2=\"a2\" />\n"+
...
"</x>";
			...
			assertNoErrorwarnings(reporter);
			xdef =
"<xd:def xmlns:xd='" + XDEFNS + "' root = 'elem'>\n"+
...
"<html>\n"+
"<head xd:script='template'><title>Panovníci èeských zemí</title></head>\n"+
"<body>\n"+
...
"    <panoval titul=\"král èeský\"><od>1230</od><do>1253</do></panoval>\n"+
"  </panovnik>\n"+
...
"<head><title>Panovníci èeských zemí</title></head>"+
