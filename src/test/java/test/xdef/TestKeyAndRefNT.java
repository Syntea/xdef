 ...
 */
public final class TestKeyAndRefNT extends XDTesterNT {
...
"<A><a><b x='1' y='2'/><c z='1 3'/></a><a><b x='1' y='3'/><c z='2 3'/></a></A>";
			a.assertEquals(xml, parse(xp, "", xml, reporter));
			a.assertEquals(2, reporter.getErrorCount());
			a.assertTrue(reporter.getErrorCount() == 2
				&& "XDEF522".equals(reporter.getReport().getMsgID())
				&& "XDEF522".equals(reporter.getReport().getMsgID()),
				reporter.printToString());
			xdef =
...
"</xd:def>";
			...
			a.assertEquals(xml, parse(xp, "", xml, reporter));
			a.assertTrue(reporter.getErrorCount() == 3, reporter.printToString());
			xdef =
"<xd:def xmlns:xd='" + XDEFNS + "' root='A'>\n"+
"<xd:declaration scope='local'>\n"+
"  type flt float(1,6);\n"+
...
"<A><a><b x='1' y='2'/><c z='1 3'/></a><a><b x='1' y='4'/><c z='2 4'/></a></A>";
			parse(xp, "", xml, reporter);
			a.assertEquals(4, reporter.getErrorCount());
			a.assertTrue(reporter.errorWarnings()
				&& "XDEF522".equals(reporter.getReport().getMsgID())
...
"</A>";
			parse(xp, "", xml, reporter);
			a.assertTrue(reporter.printToString().indexOf("XDEF523") > 0,
...
"<a a='5'><b b='5'/></a>";
			parse(xp, "", xml, reporter);
			s = reporter.printToString();
			a.assertTrue(s.indexOf("XDEF522") > 0);
...
/*#end*/
			...
			a.assertEquals(getResrcStr(getClass(), dataDir + "TestKeyAndRef2.xml"),
				parse(xp, "", dataDir + "TestKeyAndRef2.xml",reporter));
			a.assertNoErrors(reporter);

			xp = compile(dataDir + "TestKeyAndRef3.xdef");
			a.assertEquals(getResrcStr(getClass(), dataDir + "TestKeyAndRef3.xml"),
				parse(xp, "", dataDir + "TestKeyAndRef3.xml", reporter));
			a.assertNoErrors(reporter);
			a.assertEquals(getResrcStr(getClass(), dataDir + "TestKeyAndRef3_1.xml"),
				parse(xp, "", dataDir + "TestKeyAndRef3_1.xml", reporter));
			a.assertNoErrors(reporter);

			xp = compile(dataDir + "TestKeyAndRef4.xdef");
			a.assertEquals(getResrcStr(getClass(), dataDir + "TestKeyAndRef4.xml"),
			...
			a.assertEquals(getResrcStr(getClass(), dataDir + "TestKeyAndRef5.xml"),
				parse(xp, "", dataDir + "TestKeyAndRef5.xml", reporter));
			a.assertNoErrors(reporter);

			xp = compile(dataDir + "TestKeyAndRef6.xdef");
			a.assertEquals(getResrcStr(getClass(), dataDir + "TestKeyAndRef6.xml"),
			...
			a.assertEquals(getResrcStr(getClass(), dataDir + "TestKeyAndRef7.xml"),
...
" </Test>";
			...
			a.assertEquals(2, reporter.getErrorCount(), reporter.toString());
			xdef = // test CHIID
"<xd:def xmlns:xd='" + XDEFNS + "' root='Test' >\n" +
" <xd:declaration>\n" +
"    type at   int();\n" +
