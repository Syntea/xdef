...
public class Z6 implements cz.syntea.xdef.component.XComponent{
  ...
  public java.util.Date dateOfDatumVydani() {
    return cz.syntea.xdef.sys.SDatetime.getDate(_DatumVydani);
  }
  public java.sql.Timestamp timestampOfDatumVydani() {
    return cz.syntea.xdef.sys.SDatetime.getTimestamp(_DatumVydani);
  }
...
//<editor-fold defaultstate="collapsed" desc="XComponent interface">
  ...
  public Z6() {}
  public Z6(cz.syntea.xdef.component.XComponent p,
  ...
  public Z6(cz.syntea.xdef.component.XComponent p, cz.syntea.xdef.proc.XXNode xx){
    org.w3c.dom.Element el=xx.getElement();
    XD_NodeName=el.getNodeName(); XD_NamespaceURI=el.getNamespaceURI();
    XD_XPos=xx.getXPos();
    XD_Model=xx.getXMElement().getXDPosition();
    XD_Object = (XD_Parent=p)!=null ? p.xGetObject() : null;
    if (!"0AE2E33020639C07FEC6CF4D70DA598E".equals(
