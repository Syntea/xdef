...
public class Y16d implements cz.syntea.xdef.component.XComponent{
...
//<editor-fold defaultstate="collapsed" desc="XComponent interface">
  ...
  public Y16d() {}
  public Y16d(cz.syntea.xdef.component.XComponent p,
  ...
  public Y16d(cz.syntea.xdef.component.XComponent p, cz.syntea.xdef.proc.XXNode xx){
    org.w3c.dom.Element el=xx.getElement();
    XD_NodeName=el.getNodeName(); XD_NamespaceURI=el.getNamespaceURI();
    XD_XPos=xx.getXPos();
    XD_Model=xx.getXMElement().getXDPosition();
    XD_Object = (XD_Parent=p)!=null ? p.xGetObject() : null;
    if (!"78F2197DF503C2B8796E736BDD4C968B".equals(
  ...
  private String XD_NamespaceURI = "y.int";
  private int XD_Index = -1;
  private String XD_XPos;
  private String XD_Model="Y16#y";
  @Override
