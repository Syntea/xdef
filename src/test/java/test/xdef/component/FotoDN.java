...
public class FotoDN implements cz.syntea.xdef.component.XComponent{
...
//<editor-fold defaultstate="collapsed" desc="XComponent interface">
  ...
  public org.w3c.dom.Node toXml(org.w3c.dom.Document doc) {
    ...
    if (getFoto_Ref() != null)
      el.setAttribute("Foto_Ref", getFoto_Ref());
    return el;
  }
  @Override
  ...
  public FotoDN() {}
  public FotoDN(cz.syntea.xdef.component.XComponent p,
  ...
  public FotoDN(cz.syntea.xdef.component.XComponent p, cz.syntea.xdef.proc.XXNode xx){
    org.w3c.dom.Element el=xx.getElement();
    XD_NodeName=el.getNodeName(); XD_NamespaceURI=el.getNamespaceURI();
    XD_XPos=xx.getXPos();
    XD_Model=xx.getXMElement().getXDPosition();
    XD_Object = (XD_Parent=p)!=null ? p.xGetObject() : null;
    if (!"55B594D7B663FB15A176780471158494".equals(
