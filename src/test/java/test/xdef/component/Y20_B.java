...
public class Y20_B implements cz.syntea.xdef.component.XComponent{
...
//<editor-fold defaultstate="collapsed" desc="XComponent interface">
  ...
  public Y20_B() {}
  public Y20_B(cz.syntea.xdef.component.XComponent p,
  ...
  public Y20_B(cz.syntea.xdef.component.XComponent p, cz.syntea.xdef.proc.XXNode xx){
...
public static class X implements cz.syntea.xdef.component.XComponent{
  ...
  public java.util.List<test.xdef.component.Y20_B.X> listOfX() {return _X;}
  public void setb(String x) {_b = x;}
  public void addX(test.xdef.component.Y20_B.X x) {
    if (x != null) {
        if (x.xGetXPos() == null)
...
//<editor-fold defaultstate="collapsed" desc="XComponent interface">
  ...
  public X(cz.syntea.xdef.component.XComponent p, cz.syntea.xdef.proc.XXNode xx){
    ...
    XD_Model=xx.getXMElement().getXDPosition();
    XD_Object = (XD_Parent=p)!=null ? p.xGetObject() : null;
    if (!"FDCCAC90351DF9BE04473393029775FF".equals(
      xx.getXMElement().getDigest())) { //incompatible element model
      throw new cz.syntea.xdef.sys.SRuntimeException(
        cz.syntea.xdef.msg.XDEF.XDEF374);
    }
  ...
  private String _b;
  private final java.util.List<test.xdef.component.Y20_B.X> _X =
  ...
  @Override
  public cz.syntea.xdef.component.XComponent xCreateXChild(cz.syntea.xdef.proc.XXNode xx)
    {return new test.xdef.component.Y20_B.X(this, xx);}
  @Override
  public void xAddXChild(cz.syntea.xdef.component.XComponent xc) {
    xc.xSetNodeIndex(XD_ndx++);
    listOfX().add((test.xdef.component.Y20_B.X) xc); //Y20#B/X/X
  }
  @Override
  public void xSetAny(org.w3c.dom.Element el) {}
// </editor-fold>
