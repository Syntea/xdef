...
public class Y13 implements cz.syntea.xdef.component.XComponent{
  public Y13B getB() {return _B;}
...
//<editor-fold defaultstate="collapsed" desc="XComponent interface">
  ...
  public Y13() {}
  public Y13(cz.syntea.xdef.component.XComponent p,
  ...
  public Y13(cz.syntea.xdef.component.XComponent p, cz.syntea.xdef.proc.XXNode xx){
    org.w3c.dom.Element el=xx.getElement();
    XD_NodeName=el.getNodeName(); XD_NamespaceURI=el.getNamespaceURI();
    XD_XPos=xx.getXPos();
    XD_Model=xx.getXMElement().getXDPosition();
    XD_Object = (XD_Parent=p)!=null ? p.xGetObject() : null;
    if (!"0EC5B70E7397F37598D8DA547FA2159F".equals(
