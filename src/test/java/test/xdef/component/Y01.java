...
public class Y01 implements cz.syntea.xdef.component.XComponent{
...
//<editor-fold defaultstate="collapsed" desc="XComponent interface">
  ...
  public Y01() {}
  public Y01(cz.syntea.xdef.component.XComponent p,
  ...
  public Y01(cz.syntea.xdef.component.XComponent p, cz.syntea.xdef.proc.XXNode xx){
    org.w3c.dom.Element el=xx.getElement();
    XD_NodeName=el.getNodeName(); XD_NamespaceURI=el.getNamespaceURI();
    XD_XPos=xx.getXPos();
    XD_Model=xx.getXMElement().getXDPosition();
    XD_Object = (XD_Parent=p)!=null ? p.xGetObject() : null;
    if (!"904F00D4F39A0F923DA9D647F4553280".equals(
  ...
  private String XD_Model="Y01#Test";
  @Override
  ...
  public cz.syntea.xdef.component.XComponent xCreateXChild(cz.syntea.xdef.proc.XXNode xx)
    {return new test.xdef.component.s.Y01Operation(this, xx);}
  @Override
  public void xAddXChild(cz.syntea.xdef.component.XComponent xc) {
    xc.xSetNodeIndex(XD_ndx++);
    setOperation((test.xdef.component.s.Y01Operation) xc); //Y01#Test/Operation
  }
  @Override
