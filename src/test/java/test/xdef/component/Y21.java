...
public class Y21 implements org.xdef.component.XComponent{
  ...
  public void setb(test.xdef.component.Y21_enum x){
_b=x;}
  public void set$value(test.xdef.component.Y21_enum x){
_$value=x;}
  public void addB(Y21.B x) {if (x!=null) _B.add(x);}
  public void set$value1(test.xdef.component.Y21_enum x){
_$value1=x;}
...
public static class B implements org.xdef.component.XComponent{
  ...
  public test.xdef.component.Y21_enum get$value() {return _$value;}
  public void setc(test.xdef.TestXComponents_Y21enum x){
_c=x;}
  public void set$value(test.xdef.component.Y21_enum x){
_$value=x;}
