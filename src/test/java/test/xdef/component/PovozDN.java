...
//<editor-fold defaultstate="collapsed" desc="XComponent interface">
  ...
  public PovozDN() {}
  public PovozDN(cz.syntea.xdef.component.XComponent p,
  ...
  public PovozDN(cz.syntea.xdef.component.XComponent p, cz.syntea.xdef.proc.XXNode xx){
    org.w3c.dom.Element el=xx.getElement();
    XD_NodeName=el.getNodeName(); XD_NamespaceURI=el.getNamespaceURI();
    XD_XPos=xx.getXPos();
    XD_Model=xx.getXMElement().getXDPosition();
    XD_Object = (XD_Parent=p)!=null ? p.xGetObject() : null;
    if (!"00EE7A307C5FA656032C563C188FEB0B".equals(
  ...
  public cz.syntea.xdef.component.XComponent xCreateXChild(cz.syntea.xdef.proc.XXNode xx) {
    ...
    if ("SouborD1A#PovozDN/$mixed/Skoda".equals(s))
      return new test.xdef.component.Z3(this, xx);
    return new Vlastnik(this, xx); // SouborD1A#PovozDN/$mixed/Vlastnik
  }
  @Override
  public void xAddXChild(cz.syntea.xdef.component.XComponent xc) {
    ...
    if ("SouborD1A#PovozDN/$mixed/JinaSkoda".equals(s))
      ...
      setVlastnik((Vlastnik) xc); //SouborD1A#PovozDN/$mixed/Vlastnik
  }
  @Override
