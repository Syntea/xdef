...
public class J implements cz.syntea.xdef.component.XComponent{
...
//<editor-fold defaultstate="collapsed" desc="XComponent interface">
  ...
  public java.util.List<cz.syntea.xdef.component.XComponent> xGetNodeList() {
    ...
    cz.syntea.xdef.component.XComponentUtil.addXC(a, getB2());
    cz.syntea.xdef.component.XComponentUtil.addXC(a, getC2());
    return XD_List = a;
  }
  public J() {}
  public J(cz.syntea.xdef.component.XComponent p,
  ...
  public J(cz.syntea.xdef.component.XComponent p, cz.syntea.xdef.proc.XXNode xx){
...
public static class B2 implements cz.syntea.xdef.component.XComponent{
...
//<editor-fold defaultstate="collapsed" desc="XComponent interface">
  ...
  public java.util.List<cz.syntea.xdef.component.XComponent> xGetNodeList() {
    return new java.util.ArrayList<cz.syntea.xdef.component.XComponent>();}
  public B2() {}
  public B2(cz.syntea.xdef.component.XComponent p,
    String name, String ns, String xPos, String XDPos) {
    XD_NodeName=name; XD_NamespaceURI=ns;
    XD_XPos=xPos;
    XD_Model=XDPos;
  ...
  public B2(cz.syntea.xdef.component.XComponent p, cz.syntea.xdef.proc.XXNode xx){
    org.w3c.dom.Element el=xx.getElement();
    XD_NodeName=el.getNodeName(); XD_NamespaceURI=el.getNamespaceURI();
    XD_XPos=xx.getXPos();
    XD_Model=xx.getXMElement().getXDPosition();
    XD_Object = (XD_Parent=p)!=null ? p.xGetObject() : null;
    if (!"26F97DB9021D3CC7F38E6F0138CCA66B".equals(
      xx.getXMElement().getDigest())) { //incompatible element model
      throw new cz.syntea.xdef.sys.SRuntimeException(
        cz.syntea.xdef.msg.XDEF.XDEF374);
    }
