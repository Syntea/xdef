...
public class Y02 implements test.xdef.component.s.Y01Part,cz.syntea.xdef.component.XComponent{
...
//<editor-fold defaultstate="collapsed" desc="XComponent interface">
  ...
  public Y02() {}
  public Y02(cz.syntea.xdef.component.XComponent p,
  ...
  public Y02(cz.syntea.xdef.component.XComponent p, cz.syntea.xdef.proc.XXNode xx){
    org.w3c.dom.Element el=xx.getElement();
    XD_NodeName=el.getNodeName(); XD_NamespaceURI=el.getNamespaceURI();
    XD_XPos=xx.getXPos();
    XD_Model=xx.getXMElement().getXDPosition();
    XD_Object = (XD_Parent=p)!=null ? p.xGetObject() : null;
    if (!"8CA6859CFC76F9874BBB173F3C760348".equals(
