...
public class Y06B implements test.xdef.TestXComponents_Y06XCDomain,cz.syntea.xdef.component.XComponent{
...
//<editor-fold defaultstate="collapsed" desc="XComponent interface">
  ...
  public Y06B() {}
  public Y06B(cz.syntea.xdef.component.XComponent p,
  ...
  public Y06B(cz.syntea.xdef.component.XComponent p, cz.syntea.xdef.proc.XXNode xx){
    org.w3c.dom.Element el=xx.getElement();
    XD_NodeName=el.getNodeName(); XD_NamespaceURI=el.getNamespaceURI();
    XD_XPos=xx.getXPos();
    XD_Model=xx.getXMElement().getXDPosition();
    XD_Object = (XD_Parent=p)!=null ? p.xGetObject() : null;
    if (!"EF2736CA066E391EA4011EF4B6FF6A15".equals(
  ...
  private String XD_Model="Y06#A/B";
  @Override
