...
public class B implements cz.syntea.xdef.component.XComponent{
  ...
  public java.sql.Timestamp timestampOfdate() {
    return cz.syntea.xdef.sys.SDatetime.getTimestamp(_date);
  }
  ...
  public java.sql.Timestamp timestampOftime() {
    return cz.syntea.xdef.sys.SDatetime.getTimestamp(_time);
  }
...
//<editor-fold defaultstate="collapsed" desc="XComponent interface">
  ...
  public B(cz.syntea.xdef.component.XComponent p, cz.syntea.xdef.proc.XXNode xx){
    ...
    XD_Object = (XD_Parent=p)!=null ? p.xGetObject() : null;
    if (!"E67889A263F3125F9594FC1093A92104".equals(
