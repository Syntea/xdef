...
"</messages>";
			...
			assertTrue(s.indexOf("XDEF500&{line}{; øádka=}&{column}{;"
...
"</xd:collection>\n";
			xml =
"<messages>\n"+
"  <XDEF500 ces=\"&amp;{line}{; øádka=}&amp;{column}{; sloupec=}&amp;{sysId}"+
"{; zdroj='}{'}\"/>\n"+
"  <XDEF501 ces=\"Výskyt nepovoleného elementu '&amp;{child}'&amp;{xpath}"+
 "{ v }&amp;{#XDEF500}\"/>\n"+
"  <XDEF502 ces=\"Element '&amp;{child}' není definován jako 'root'"+
"{ v }&amp;{#XDEF500}\"/>\n"+
"</messages>\n";
			xp = compile(xdef);
			strw = new StringWriter();
			...
			assertEq(
"XDEF500 &{LINE}{; ØÁDKA=}&{COLUMN}{; SLOUPEC=}&{SYSID}{; ZDROJ='}{'}\n"+
"XDEF501 VÝSKYT NEPOVOLENÉHO ELEMENTU '&{CHILD}'&{XPATH}{ V }&{#XDEF500}\n"+
"XDEF502 ELEMENT '&{CHILD}' NENÍ DEFINOVÁN JAKO 'ROOT'{ V }&{#XDEF500}\n",
				strw.toString());
			//macro
			xdef =
"<xd:collection xmlns:xd = '" + XDEFNS + "'>\n"+
