...
public class House implements org.xdef.component.XComponent{
  ...
  public java.util.List<Person> listOfPerson() {return _Person;}
...
//<editor-fold defaultstate="collapsed" desc="XComponent interface">
  ...
  public House(org.xdef.component.XComponent p, org.xdef.proc.XXNode xx){
    org.w3c.dom.Element el=xx.getElement();
    XD_NodeName=el.getNodeName(); XD_NamespaceURI=el.getNamespaceURI();
    XD_XPos=xx.getXPos();
    XD_Model=xx.getXMElement().getXDPosition();
    XD_Object = (XD_Parent=p)!=null ? p.xGetObject() : null;
    if (!"8650CE4B3121B517580854C14D3637B3".equals(
  ...
  private final java.util.List<Person> _Person = new java.util.ArrayList<Person>();
  ...
  public void xSetAttr(org.xdef.proc.XXNode xx,
    ...
    else setNum(parseResult.getParsedValue().intValue());
  }
  @Override
  public org.xdef.component.XComponent xCreateXChild(org.xdef.proc.XXNode xx)
    {return new Person(this, xx);}
  @Override
  public void xAddXChild(org.xdef.component.XComponent xc) {
    xc.xSetNodeIndex(XD_ndx++);
    listOfPerson().add((Person) xc); //A#House/Person
  }
  @Override
