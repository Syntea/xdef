 ...
 * the interface {@link cz.syntea.xdef.proc.XXNode}. You can read of or set to
 *  variables of a XDPool by methods of {@link cz.syntea.xdef.proc.XXNode}:
 * <p>{@link cz.syntea.xdef.proc.XXNode#getVariable(String)},
 * {@link cz.syntea.xdef.proc.XXNode#setVariable(String, Object)},
 * {@link cz.syntea.xdef.proc.XXNode#setUserObject(Object)},
 * {@link cz.syntea.xdef.proc.XXNode#getUserObject()},
 * {@link cz.syntea.xdef.proc.XXNode#getUserObject()},
 * {@link cz.syntea.xdef.proc.XXNode#setXDContext(org.w3c.dom.Node node)}.
 * {@link cz.syntea.xdef.proc.XXNode#getXDContext()}.</p>
 ...
 * ... set variables if necessary - see {@link cz.syntea.xdef.proc.XXNode}
 ...
 * } else {//no errors
 *     ... get variables if necessary - see {@link cz.syntea.xdef.proc.XXNode}
 *     ....
 * }</tt></pre>
 ...
 * XDDocument xDoc = xp.createXDDocument(name);
 * ArrayReporter reporter = new ArrayReporter(); // here will be written errors
 * ... set data source see {@link cz.syntea.xdef.proc.XXNode}
