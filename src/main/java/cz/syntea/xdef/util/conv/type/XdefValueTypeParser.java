 ...
 */
package cz.syntea.xdef.util.conv.type;

import cz.syntea.xdef.XDConstants;
import cz.syntea.xdef.sys.SBuffer;
import cz.syntea.xdef.sys.StringParser;
import cz.syntea.xdef.impl.compile.XScriptParser;
import cz.syntea.xdef.util.conv.type.domain.Other;
import cz.syntea.xdef.util.conv.type.domain.ValueType;
import cz.syntea.xdef.util.conv.type.domain.XdefBase;
import cz.syntea.xdef.util.conv.type.domain.XdefList;
import cz.syntea.xdef.util.conv.type.domain.XdefType;
import cz.syntea.xdef.util.conv.type.domain.XsdBase;
import cz.syntea.xdef.util.conv.type.domain.XsdFacet;
import cz.syntea.xdef.util.conv.type.domain.XsdList;
import cz.syntea.xdef.util.conv.type.domain.XsdRestricted;
import cz.syntea.xdef.util.conv.type.domain.XsdUnion;
import cz.syntea.xdef.util.conv.type.domain.restr.DigitCountRestricted;
import cz.syntea.xdef.util.conv.type.domain.restr.EnumerationRestricted;
import cz.syntea.xdef.util.conv.type.domain.restr.LengthRestricted;
import cz.syntea.xdef.util.conv.type.domain.restr.PatternRestricted;
import cz.syntea.xdef.util.conv.type.domain.restr.ValueRestricted;
import cz.syntea.xdef.util.conv.type.domain.restr.WhiteSpaceRestricted;
...
public final class XdefValueTypeParser {
	...
	private XdefValueTypeParser(String type) {
		...
		_p = new XScriptParser(true, null);
