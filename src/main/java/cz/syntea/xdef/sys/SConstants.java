...
public interface SConstants {
	...
	/** Build version of software (3.1.004.003). */
	public static final String BUILD_VERSION = "3.1.004.003";
	/** Date of build version (2018-07-18). */
	public static final String BUILD_DATE = "2018-07-18";
