 ...
 * reports are instances of {@link cz.syntea.xdef.sys.Report}.
 ...
 * {@link cz.syntea.xdef.sys.Report#setLanguage(String)}. The language
 ...
 * {@link cz.syntea.xdef.sys.SUtils#getISO3Language()} and
 * {@link cz.syntea.xdef.sys.SUtils#getISO3Language(String)}.
 ...
 * {@link cz.syntea.xdef.sys.SException},
 *   {@link cz.syntea.xdef.sys.SRuntimeException},
 * {@link cz.syntea.xdef.sys.SError} or
 * {@link cz.syntea.xdef.sys.SExternalError}),
 * </li>
 * <li>written to the output stream (see
 * {@link cz.syntea.xdef.sys.ReportWriter}). The files created by ReportWriter
 * may be read with {@link cz.syntea.xdef.sys.ReportReader}.
 * <p>The classes providing reading and writing of reports are
 * {@link cz.syntea.xdef.sys.FileReportReader} and
 * {@link cz.syntea.xdef.sys.FileReportWriter}. See also
 * {@link cz.syntea.xdef.sys.ArrayReporter} which provides both
 ...
 * See {@link cz.syntea.xdef.sys.RegisterReportTables}.
 *
 * <H2>Parsing tools</H2>
 * Parsing of data is provided with implementation of the SParser interface
 * (see {@link cz.syntea.xdef.sys.SParser}).There is available the
 * class implementing methods for strings, streams or files
 * (see {@link cz.syntea.xdef.sys.StringParser}). It provides
 ...
 * extended Backus Naur form (see {@link cz.syntea.xdef.sys.BNFGrammar}).
 *
 ...
 * static methods of the classes {@link cz.syntea.xdef.sys.SUtils}
 * and {@link cz.syntea.xdef.sys.FUtils}.
 *
