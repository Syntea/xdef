...
////////////////////////////////////////////////////////////////////////////////
	static {
		...
		setType(XD_DATETIME, "Datetime", cz.syntea.xdef.sys.SDatetime.class);
		setType(XD_DURATION, "Duration", cz.syntea.xdef.sys.SDuration.class);
		setType(XD_CONTAINER, "Container", cz.syntea.xdef.XDContainer.class);
		setType(XD_REGEX, "Regex", cz.syntea.xdef.XDRegex.class);
		setType(XD_REGEXRESULT, "RegexResult",
			cz.syntea.xdef.XDRegexResult.class);
		setType(XD_BNFGRAMMAR,"BNFGrammar", cz.syntea.xdef.XDBNFGrammar.class);
		setType(XD_BNFRULE,"BNFRule", cz.syntea.xdef.XDBNFRule.class);
		setType(XD_INPUT,"Input", cz.syntea.xdef.XDInput.class);
		setType(XD_OUPUT,"Output", cz.syntea.xdef.XDOutput.class);
		setType(XX_ELEMENT, "",cz.syntea.xdef.proc.XXElement.class);
		setType(XX_DATA, "", cz.syntea.xdef.proc.XXData.class);
		setType(XD_BYTES, "Bytes", byte[].class);
		setType(XD_ELEMENT, "Element", org.w3c.dom.Element.class);
		setType(XD_EXCEPTION, "Exception",cz.syntea.xdef.XDException.class);
		setType(XD_REPORT, "Report", cz.syntea.xdef.sys.Report.class);
		setType(XD_XPATH, "XpathExpr", cz.syntea.xdef.xml.KXpathExpr.class);
		setType(XD_XQUERY,"XqueryExpr",cz.syntea.xdef.XDXQueryExpr.class);
		setType(XD_PARSER, "Parser", cz.syntea.xdef.XDParser.class);
		setType(XD_PARSERESULT, "ParseResult",
			cz.syntea.xdef.XDParseResult.class);
		setType(XD_SERVICE, "Service", cz.syntea.xdef.XDService.class);
		setType(XD_STATEMENT, "Statement", cz.syntea.xdef.XDStatement.class);
...
///////////////////////////////////////////////////////////////////////////////
		...
		parser(im,cz.syntea.xdef.impl.parsers.XSParseBoolean.class,
			"xs:boolean", "boolean", "?bool");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseJBoolean.class,"jboolean");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseJNull.class, "jnull");
		...
		parser(im,cz.syntea.xdef.impl.parsers.XSParseDecimal.class,
			"decimal", "xs:decimal");
		...
		im = genParserMetnod(0, 2, new short[] {XD_FLOAT, XD_FLOAT},
			...
			keyParam("whiteSpace", XD_STRING, false, -1, true,
				new DefString("collapse")));
		parser(im,cz.syntea.xdef.impl.parsers.XSParseDouble.class,
			"double", "xs:double");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseDouble.class,
			"float", "xs:float");
		...
		im = genParserMetnod(0, 2, new short[] {XD_DATETIME, XD_DATETIME},
			...
			keyParam("whiteSpace", XD_STRING, false, -1, true,
				new DefString("collapse")));
		parser(im,cz.syntea.xdef.impl.parsers.XSParseDatetime.class,
			"dateTime", "xs:dateTime");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseDate.class,
			"date", "xs:date");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseGDay.class,
			"xs:gDay", "gDay", "?ISOday");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseGMonth.class,
			"xs:gMonth", "gMonth", "?ISOmonth");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseGMonthDay.class,
			"xs:gMonthDay", "gMonthDay", "?ISOmonthDay");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseGYear.class,
			"gYear", "xs:gYear");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseGYearMonth.class,
			"gYearMonth", "xs:gYearMonth");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseTime.class,
			"xs:time", "time", "?ISOtime");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseISOYearMonth.class,
			"?ISOyearMonth");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseDateYMDhms.class,
			"dateYMDhms");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseEmailDate.class,
			"emailDate");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseISOYear.class,
			"?ISOyear");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseISODate.class,
			"?ISOdate");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseISODateTime.class,
			"?ISOdateTime");
		...
		parser(im,cz.syntea.xdef.impl.parsers.XSParseNonNegativeInteger.class,
			"nonNegativeInteger", "xs:nonNegativeInteger");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseNonPositiveInteger.class,
			"nonPositiveInteger", "xs:nonPositiveInteger");
		parser(im,cz.syntea.xdef.impl.parsers.XSParsePositiveInteger.class,
			"positiveInteger", "xs:positiveInteger");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseShort.class,
			"short", "xs:short");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseUnsignedByte.class,
			"unsignedByte", "xs:unsignedByte");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseUnsignedInt.class,
			"unsignedInt", "xs:unsignedInt");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseUnsignedShort.class,
		...
		parser(im,cz.syntea.xdef.impl.parsers.XSParseUnsignedLong.class,
		...
		im = genParserMetnod(0, 2, new short[] {XD_INT,XD_INT},
			...
			keyParam("whiteSpace", XD_STRING, false, -1, true,
				new DefString("collapse")));
		parser(im,cz.syntea.xdef.impl.parsers.XSParseAnyURI.class,
			"anyURI", "xs:anyURI");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseName.class,
			"xs:Name", "Name");
		...
		parser(im,cz.syntea.xdef.impl.parsers.XSParseString.class,
			"string", "xs:string");
		...
		parser(im,cz.syntea.xdef.impl.parsers.XSParseNormalizedString.class,
			"xs:normalizedString", "normalizedString", "?normString");
		...
		im = genParserMetnod(0, 2, new short[] {XD_INT, XD_INT}, XD_STRING,
			...
			keyParam("whiteSpace", XD_STRING, false,  -1, false,
				new DefString("preserve"), new DefString("collapse"),
				new DefString("replace")));
		parser(im,cz.syntea.xdef.impl.parsers.XDParseLetters.class, "letters");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseAn.class, "an");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseNum.class, "num");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseCDATA.class, "CDATA");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseJNumber.class, "jnumber");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseJString.class, "jstring");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseJValue.class, "jvalue");

		im = genParserMetnod(0, 0, null, XD_ANY,
			keyParam("enumeration", XD_ANY, true, -1,false),
			keyParam("item", XD_PARSER, true, -1,false),
			keyParam("pattern", XD_STRING, true, -1,false));
		parser(im,cz.syntea.xdef.impl.parsers.XSParseUnion.class,
			"union", "xs:union");
		...
		im = genParserMetnod(0, 2, new short[] {XD_INT, XD_INT}, XD_STRING,
			...
			keyParam("whiteSpace", XD_STRING, false, -1, true,
				new DefString("collapse")));
		parser(im,cz.syntea.xdef.impl.parsers.XSParseID.class, "ID", "xs:ID");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseIDREF.class,
			"IDREF", "xs:IDREF");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseENTITY.class,
			"ENTITY", "xs:ENTITY");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseNMTOKEN.class,
			"xs:NMTOKEN", "NMTOKEN", "?normToken");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseToken.class,
			"token", "xs:token");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseCHKID.class, "CHKID");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseSET.class, "SET");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseCHKIDS.class, "CHKIDS");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseNOTATION.class,
			"NOTATION", "xs:NOTATION");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseNCName.class,
			"xs:NCName", "NCName", "?NCname");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseQName.class,
			"xs:QName", "QName", "?Qname");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseLanguage.class,
			"xs:language", "language", "?ISOlanguage");
		...
		im = genParserMetnod(0, 2, new short[] {XD_INT, XD_INT}, XD_CONTAINER,
			...
			keyParam("whiteSpace", XD_STRING, false, -1, true,
				new DefString("collapse")));
		parser(im,cz.syntea.xdef.impl.parsers.XSParseIDREFS.class,
			"IDREFS", "xs:IDREFS");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseENTITIES.class,
			"ENTITIES", "xs:ENTITIES");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseNMTOKENS.class,
			"xs:NMTOKENS", "NMTOKENS", "?normTokens", "?nmTokens");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseCHKIDS.class, "CHKIDS");
		...
		im = genParserMetnod(0, 2, new short[] {XD_DURATION,XD_DURATION},
			...
			keyParam("whiteSpace", XD_STRING, false, -1, true,
				new DefString("collapse")));
		parser(im,cz.syntea.xdef.impl.parsers.XSParseDuration.class,
			"xs:duration", "duration", "?ISOduration");
		...
		im = genParserMetnod(0, 2, new short[] {XD_INT, XD_INT}, XD_BYTES,
			...
			keyParam("whiteSpace", XD_STRING, false, -1, true,
				new DefString("collapse")));
		parser(im,cz.syntea.xdef.impl.parsers.XSParseBase64Binary.class,
			"base64Binary", "xs:base64Binary", "base64");
		parser(im,cz.syntea.xdef.impl.parsers.XSParseHexBinary.class,
			"hexBinary", "xs:hexBinary");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseHex.class, "hex");
		...
		im = genParserMetnod(0, 1, new short[] {XD_PARSER}, XD_CONTAINER,
			...
			keyParam("whiteSpace", XD_STRING, false, -1, true,
				new DefString("collapse")));
		parser(im,cz.syntea.xdef.impl.parsers.XSParseList.class,
			"list", "xs:list");
////////////////////////////////////////////////////////////////////////////////
// X-Script parsers
////////////////////////////////////////////////////////////////////////////////
		im = genParserMetnod(0, 2, new short[] {XD_INT, XD_INT}, XD_STRING,
			...
			keyParam("whiteSpace", XD_STRING, false, -1, true,
				new DefString("collapse")));
		parser(im,cz.syntea.xdef.impl.parsers.XDParseSequence.class,
		...
		parser(im, cz.syntea.xdef.impl.parsers.XDParseDec.class, "dec");

		im = genParserMetnod(0, 0, null, XD_STRING,
			keyParam("enumeration", XD_BYTES, true, -1,false),
			keyParam("length", XD_INT, false, -1, true,/*fixed*/
				new DefLong(16)));
		parser(im,cz.syntea.xdef.impl.parsers.XDParseMD5.class, "MD5");
		...
		im = genParserMetnod(0, 1, new short[]{XD_ELEMENT}, XD_CONTAINER,
			...
			keyParam("whiteSpace", XD_STRING, false, -1, true,
				new DefString("collapse")));
		parser(im,cz.syntea.xdef.impl.parsers.XDParseNCNameList.class,
			"NCNameList", "?NCnameList");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseQNameList.class,
			"QNameList", "?QnameList");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseISOLanguages.class,
		...
		im = genParserMetnod(0, 1, null, XD_STRING,
			...
			keyParam("whiteSpace", XD_STRING, false, -1, true,
				new DefString("collapse")));
		parser(im,cz.syntea.xdef.impl.parsers.XDParseQNameURI.class,
			"QNameURI", "?QnameURI");
		...
		im = genParserMetnod(0, 1, new short[] {XD_STRING}, XD_CONTAINER,
			keyParam("argument", XD_ANY, true, 1,false),
				...
				keyParam("whiteSpace", XD_STRING, false, -1, true,
					new DefString("collapse")));
		parser(im,cz.syntea.xdef.impl.parsers.XDParseQNameURIList.class,
		...
		im = genParserMetnod(1, 2, new short[] {XD_STRING, XD_STRING},
			...
			keyParam("whiteSpace", XD_STRING, false, -1, true,
				new DefString("collapse")));
		parser(im,cz.syntea.xdef.impl.parsers.XDParseXDatetime.class,
			"xdatetime", "?datetime");

		im = genParserMetnod(0, 0, null, XD_STRING);
		parser(im,cz.syntea.xdef.impl.parsers.XDParseEmpty.class, "empty");

		im = genParserMetnod(1, 1, new short[] {XD_STRING}, XD_STRING,
			keyParam("argument", XD_STRING, false,  0, false));
		parser(im,cz.syntea.xdef.impl.parsers.XDParseEq.class, "eq");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseEqi.class, "eqi");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseStarts.class, "starts");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseStartsi.class, "startsi");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseEnds.class, "ends");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseEndsi.class, "endsi");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseContains.class,"contains");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseContainsi.class,
			"containsi");
		parser(im,cz.syntea.xdef.impl.parsers.XDParsePic.class,
			"pic", "?picture");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseRegex.class, "regex");

		im = genParserMetnod(1, Integer.MAX_VALUE, new short[] {XD_STRING},
			XD_STRING,
			keyParam("argument", XD_CONTAINER, true,  0, false));
		parser(im,cz.syntea.xdef.impl.parsers.XDParseEnum.class, "enum");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseEnumi.class,
			"enumi", "?listi");

		im = genParserMetnod(1, 1, new short[] {XD_STRING}, XD_STRING,
			keyParam("argument", XD_CONTAINER, true,  0, false));
		// This type is deprecated, replace with "list(%item=typ)"
		parser(im,cz.syntea.xdef.impl.parsers.XDParseTokens.class, "?tokens");
		parser(im,cz.syntea.xdef.impl.parsers.XDParseTokensi.class, "?tokensi");

		im = genParserMetnod(1, 2, new short[] {XD_ANY, XD_STRING},
			XD_STRING,
			keyParam("a2", XD_ANY, true, 1, false),
			keyParam("a1", XD_ANY, true, 0, false));
		parser(im,cz.syntea.xdef.impl.parsers.XDParseBNF.class, "BNF");
		// This type is deprecated, replace with "list(%item=typ)"
		im = genParserMetnod(1, 1, new short[] {XD_PARSER}, XD_STRING,
			keyParam("item", XD_PARSER, true, 0, false));
		parser(im,cz.syntea.xdef.impl.parsers.XSParseList.class, "?ListOf");
////////////////////////////////////////////////////////////////////////////////
// implemented methods
////////////////////////////////////////////////////////////////////////////////
...
//			TEXT_MODE, 1, 1, XD_STRING), "addPI");
		...
		method(ti, genInternalMethod(CREATE_ELEMENTS, 	XD_CONTAINER,
			ANY_MODE, 1, 3, XD_INT, XD_STRING, XD_STRING),
			"newElements");
...
//			ANY_MODE, 1, 1, XD_STRING), "parseDuration");
		...
		method(ti, genInternalMethod(DEL_ATTR, XD_VOID, //remove attribute
			(byte) (TEXT_MODE + ELEMENT_MODE), 1, 2,
			XD_STRING, XD_STRING),"removeAttr");
		method(ti, genInternalMethod(REMOVE_TEXT, XD_VOID,
			TEXT_MODE, 0, 0), "removeText");
		...
		method(ti, genInternalMethod(REPLACEFIRST_S, XD_STRING,
			ANY_MODE, 3, 3, XD_STRING, XD_STRING, XD_STRING),
			"replaceFirst");
...
////////////////////////////////////////////////////////////////////////////////
		...
		method(ti, genInternalMethod(CONTEXT_ITEMTYPE, XD_INT,
			ANY_MODE, 2, 2, XD_CONTAINER, XD_INT),
		...
		method(ti, genInternalMethod(CONTEXT_TO_ELEMENT, XD_ELEMENT,
			ANY_MODE, 1, 3, XD_CONTAINER, XD_STRING, XD_STRING),
			"toElement");
...
////////////////////////////////////////////////////////////////////////////////
		...
		method(ti, genInternalMethod(GET_MESSAGE, XD_STRING, ANY_MODE, 1, 1,
			XD_EXCEPTION), "getMessage");
...
////////////////////////////////////////////////////////////////////////////////
		...
		method(ti, genInternalMethod(PUT_ERROR1, XD_BOOLEAN,
			ANY_MODE, 2, 4,
			XD_OUPUT, XD_STRING, XD_STRING, XD_STRING),
			"error");
		method(ti, genInternalMethod(GET_REPORT, XD_REPORT,
...
////////////////////////////////////////////////////////////////////////////////
		...
		method(ti, genInternalMethod(SET_PARSED_ERROR, XD_PARSERESULT,
			ANY_MODE, 2, 4,
			XD_PARSERESULT, XD_STRING, XD_STRING, XD_STRING),
			"error", "?setError");
		method(ti, genInternalMethod(GET_PARSED_DOUBLE, XD_FLOAT,
...
////////////////////////////////////////////////////////////////////////////////
		...
		method(ti, genInternalMethod(REPORT_SETPARAM, XD_REPORT,
			ANY_MODE, 3, 3, XD_REPORT, XD_STRING, XD_STRING),
			"setParameter");
...
////////////////////////////////////////////////////////////////////////////////
		...
		method(ti, genInternalMethod(GET_LASTINDEXOFSTRING, XD_INT,
			ANY_MODE, 2, 3, XD_STRING, XD_STRING, XD_INT),
			"lastIndexOf");
...
////////////////////////////////////////////////////////////////////////////////
	...
	/** Set type parameters.
	 * @param type type ID (see cz.syntea.xdef.XDValueID).
...
////////////////////////////////////////////////////////////////////////////////
	...
	static Class<?> getTypeClass(short type) {
		...
		return result == null ?
			cz.syntea.xdef.impl.compile.CodeUndefined.class : result;
	}
