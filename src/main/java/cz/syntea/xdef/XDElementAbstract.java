 ...
 *
 * File: XDElementAbstract.java, created 2011-10-03.
...
implements Element, XDElement, XDValue, NamedNodeMap {
	...
	public XDNamedValue getXDNamedItem(String name) {
		return hasAttribute(name) ?
			new cz.syntea.xdef.impl.code.DefNamedValue(name,
				new cz.syntea.xdef.impl.code.DefString(getAttribute(name))) : null;
	}
	@Override
