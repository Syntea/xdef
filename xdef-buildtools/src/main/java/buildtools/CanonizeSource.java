...
public class CanonizeSource {
     ...
     * @param tabs if true, leading spaces are replaced by tabs, if false the leading tabs are replaced by spaces.
     * @param n number of spaces per tab. If this argument is -1 no modifications of leading spaces is done.
     * @param header name of file containing string with header ("copyright") information which will be inserted
     * or replaced as the top of the source. If the file is the empty (i.e. it has the zero length) the header
     * information is deleted. If this argument is null no header information is processed. Note the information is
     * considered in the form of Java or "C" comment.
     * @param tail the name of file containing string with tail ("log") information which will be added to the end
     * of source or it will replace the existing information. If the file is the empty (i.e. it has zero length) then
     * the existing tail will be information is deleted. If this argument is null no tail information is processed.
