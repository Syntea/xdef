...
public class CanonizeSource {
	 ...
	 * @author Vaclav Trojan
	 */
	static class NameWildCardFilter implements java.io.FileFilter {
		 ...
		 */
		public static final boolean chkWildcard(final String wc,final String f){
			int j = 1, i = 0;
			int fnLen = f.length() - 1, wcLen = wc.length() - 1;
			char ch = wc.charAt(0);
			while (i <= fnLen) {
				switch (ch) {
					case '*':
