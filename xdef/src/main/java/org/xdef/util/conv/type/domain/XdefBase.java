...
public class XdefBase {
	...
	public static final XdefBase XDATETIME =
		new XdefBase(Id.XDATETIME, XdNames.XDATETIME);
	...
	public static interface Id {
		...
		/** <code>xdatetime</code> type id.*/
		public static final int XDATETIME = CONTAINS_I + 1;
		/** <code>dateYMDhms</code> type id.*/
		public static final int DATE_YMDHMS = XDATETIME + 1;
