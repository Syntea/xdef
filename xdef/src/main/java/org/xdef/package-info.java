/**
 * Contains interfaces for processing of Xdefinitions and
 * the factory for compilation of Xdefinitions and creation of some important
 * objects used in Xdefinition.
 * <p>
 * For any kind of usage it is necessary first to compile Xdefinition to
 * the object{@link org.xdef.XDPool}. The XDPool object can be declared
 * as static and it can be used by more parallel threads.
 * XDPool contains	compiled code generated form of all Xdefinitions.
 * To compile Xdefinition use the {@link org.xdef.XDFactory} - see
 * static methods. To execute a Xdefinition you must first create an object
 * {@link org.xdef.XDDocument}. This object contains pointer to the root
 * Xdefinition where processing will start and it contains also all instances
 ...
 * </p>
 * <p>There are several typical modes of usage of Xdefinition tools:</p>
 *
 * <UL>
 * <li>
 ...
 * unlimited size. If it is used the option "forget" in an Xdefinition the size
 ...
 * according to Xdefinition. In this mode the source data is generated by the
 * Xdefinition itself (i.e. XDPool): the data can be taken from XML object or
 * from an external database, or by setting a value. The output data are created
 * according to given Xdefinition (see
 ...
 * </UL>
 *
 * In the case you want to know properties of Xdefinition models of
 ...
 * Contains pool of Xdefinitions compiled from the source (see
 * {@link org.xdef.XDFactory}).
 * <p><b>Example:</b></p>
 * <pre><code>
 * // Prepare Xdefinition file
 ...
 * <p><b>Example:</b></p>
 * <pre><code>
 * // 2. Validate and process source XML data with Xdefinition.
 ...
 * You can create the Xdefinition from a XML document when you
