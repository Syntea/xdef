...
public interface SYS {
	...
	/** A fraction of a second in the datetime value outside the range 0..1&amp;{0}{: }&amp;{#SYS000} */
	...
	/** Directory does not exist or is not accessible: &amp;{0} */
	...
	public static final long SYS037 = 953221146L;
	/** File is too big: &amp;{0} */
	...
	/** Error in datetime mask format: unclosed quoted literal or option&amp;{0}{, position: }&amp;{#SYS000} */
	public static final long SYS049 = 953221157L;
	/** Error in datetime mask format: incorrect zone format&amp;{0}{, position: }&amp;{#SYS000} */
	...
	/** Invalid value of timezone offset&amp;{#SYS000} */
	...
	/** Datetime mask error: unsupported language code&amp;{0}{: "}{"}&amp;{1}{, position: }&amp;{#SYS000} */
	public static final long SYS060 = 953221166L;
	/** Datetime mask error: unsupported time zone name&amp;{0}{: "}{"}&amp;{1}{, position: }&amp;{#SYS000} */
	public static final long SYS061 = 953221167L;
	/** Datetime mask error: incorrect initial value&amp;{0}{: "}{"}&amp;{1}{, position: }&amp;{#SYS000} */
	public static final long SYS062 = 953221168L;
	/** Datetime mask error: incorrect control character&amp;{0}{: "}{"}&amp;{1}{, position: }&amp;{#SYS000} */
	public static final long SYS063 = 953221169L;
	/** Datetime mask error: missing closing character&amp;{0}{: "}{"}&amp;{1}{, position: }&amp;{#SYS000} */
	public static final long SYS064 = 953221170L;
	/** Invalid file name: "&amp;{0}"&amp;{#SYS000} */
	public static final long SYS065 = 953221171L;
	/** Internal error&amp;{0}{: } */
	public static final long SYS066 = 953221172L;
	/** Datetime mask error: unsupported country code&amp;{0}{: "}{"}&amp;{1}{, position: }&amp;{#SYS000} */
	public static final long SYS067 = 953221173L;
	/** Fatal errors: &amp;{0}, errors: &amp;{1}, warnings: &amp;{2} */
	public static final long SYS068 = 953221174L;
	/** Data error&amp;{0}{: } */
	...
	public static final long SYS203 = 953221199L;
	...
	public static final long SYS218 = 953221207L;
	/** Incorrect parameter reference on position: &amp;{0} (report ID: &amp;{1}); */
	public static final long SYS219 = 953221208L;
	/** Default report table is incorrect or missing&amp;{0}(, localized table: ) */
	public static final long SYS220 = 953221209L;
	/** Report &amp;{0} from table &amp;{1} is missing in the default table */
	public static final long SYS221 = 953221210L;
	/** No report tables generated */
	public static final long SYS223 = 953221211L;
	/** Report &amp;{0} which is in the default table is missing in table &amp;{1} */
	public static final long SYS225 = 953221212L;
	/** Can't read properties with reports: &amp;{0} */
	public static final long SYS226 = 953221213L;
	/** System messages of X-definitions */
	public static final long SYS_DESCRIPTION = 953221214L;
	/** English */
	public static final long SYS_LANGUAGE = 953221215L;
}