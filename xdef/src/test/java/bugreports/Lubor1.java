...
/*
%interface bugreports.Lubor_XC_2 %link PlatneOdDo;
%interface bugreports.Lubor_XC_2_I extends bugreports.Lubor_XC_1 %link PlatneOdDo;
vygneruje:
// This file was generated by org.xdef.component.GenXComponent.
// X-position: "RS_common_#KriteriaDotazuGet".
// Any modifications to this file will be lost upon recompilation.
package bugreports.KriteriaDotazuGet extends bugreports;

public interface KriteriaDotazu extends org.xdef.component.XComponent {		
...
public interface KriteriaDotazuGet extends bugreports.KriteriaDotazu, org.xdef.component.XComponent {
*/		
/**/
		try {
			xdef =
"<xd:def xmlns:xd=\"http://www.xdef.org/xdef/4.2\" xd:root='PlatneOd|PlatneOdDo'>\n" +
"<PlatneOd PlatnostOd='date()'/>\n" +
"<PlatneOdDo xd:script='ref PlatneOd' PlatnostDo='date()'/>\n" +			
"<xd:component>\n" +
"  %class "+_package+".Lubor1_XC_1 %link PlatneOd;\n" +
"  %class "+_package+".Lubor1_XC_2 %link PlatneOdDo;\n" +
"\n" +
"  %interface "+_package+".Lubor1_XC_1_I %link PlatneOd;\n" +
"  %interface "+_package+".Lubor1_XC_2_I extends "+_package+".Lubor1_XC_1_I %link PlatneOdDo;\n" +
"</xd:component>\n" +
"</xd:def>";
			xp = compile(xdef);
			genXComponent(xp);
