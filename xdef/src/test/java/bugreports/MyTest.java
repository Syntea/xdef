...
"</x>";
			...
			x = XComponentUtil.get((XComponent) XComponentUtil.getList(xc, "a").get(0), "$value");
			assertEq(new ArrayList(), XComponentUtil.jlistToList((List) x));
			assertEq(new ArrayList(), x);
			x = XComponentUtil.get((XComponent) XComponentUtil.getList(xc, "a").get(1), "$value");
			assertEq("false", XComponentUtil.jlistToList((List) x).get(0));
			assertEq("false", XComponentUtil.jlistToList((List) x).get(0));
			x = XComponentUtil.get((XComponent) XComponentUtil.getList(xc, "a").get(2), "$value");
			assertEq(null, XComponentUtil.jlistToList((List) x).get(0));
			x = XComponentUtil.get((XComponent) XComponentUtil.getList(xc, "a").get(3), "$value");
