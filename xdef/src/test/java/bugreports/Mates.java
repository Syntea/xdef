...
"<xd:def xmlns:xd     =\"http://www.xdef.org/xdef/4.2\" xd:name = 'SynPLscript'\n" +
"        impl-version =\"2025/11.0\" impl-date=\"2025-11-07\"\n" +
"        xd:root      =\"SynPLscript\">\n" +
...
"        uniqueSet eventStatusSet   { statusName:       statusName(); eventName:        eventName()};  /* duplicita eventu ve statusu   */\n" +
"    </xd:declaration>\n" +
"\n" +
...
"        }\n" +
"    </xd:json>\n" +
"    <xd:component> %class bugreports.XCSynPLscript %link   SynPLscript; </xd:component>\n" +
"</xd:def>\n" +
...
"                   \"Desc\":     \"? desc()\"}\n" +
"</xd:json>\n" +
"<xd:component> %class bugreports.XCSysValues %link    SysValues; </xd:component>\n" +
"</xd:def>\n" +
...
"                 \"Desc\":     \"? desc()\"}\n" +
"</xd:json>\n" +
"<xd:component> %class bugreports.XCVariables %link   Variables; </xd:component>\n" +
"</xd:def>\n" +
...
"                   \"Desc\":     \"  desc()\"}\n" +
"</xd:json>\n" +
"<xd:component> %class bugreports.XCUserRoles %link   UserRoles; </xd:component>\n" +
"</xd:def>\n" +
...
"                    \"Params\":   \"  desc()\"}\n" +
"</xd:json>\n" +
"<xd:component> %class bugreports.XCUsedFunctions %link   UsedFunctions; </xd:component>\n" +
"</xd:def>\n" +
...
"                }\n" +
"</xd:json>\n" +
"<xd:component> %class bugreports.XCStatuses %link   Statuses; </xd:component>\n" +
"</xd:def>\n" +
...
"                    }\n" +
"</xd:json>\n" +
"<xd:component> %class bugreports.XCEndStatuses %link   EndStatuses; </xd:component>\n" +
"</xd:def>\n" +
"</xd:collection>";
			xp = compile(xdef);
			genXComponent(xp);
...
"}\n";
			...
			assertNoErrorsAndClear(reporter);
			XCSynPLscript xPLscript = (XCSynPLscript) xc;
			...
			XCSynPLscript xsyn = (XCSynPLscript) xc;
			xsyn.getjx$map();
