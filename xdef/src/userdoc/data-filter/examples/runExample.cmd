...
set cp=-classpath temp/classes;../xdef-${project.version}.jar;lib/derby-${derby.version}.jar;lib/Saxon-HE-${saxon-he.version}-xqj.jar;lib/Saxon-HE-${saxon-he.version}.jar;lib/snakeyaml-${snakeyaml.version}.jar
