...
public class Orders1 {
	public static void main(String... args) throws IOException {
		...
		FileReportWriter reporter;
		try ( // The file where to write the result
			...
			reporter = new FileReportWriter(errors);
		...
		if (reporter.errorWarnings()) {
			System.err.println("Task2.Order1 Incorrect input data");
		} else {
			System.out.println("OK, Task2.Order1");
		}
	}
}