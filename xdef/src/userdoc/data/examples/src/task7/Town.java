...
public class Town {
    ...
    public static void main(String... args) throws IOException {
        ...
        // 3. Create XDDOcument, set language for the English language, and process localized version
        ...
        // 4. Create XDDOcument, set language for the German language, and process localized version
        xd = xPool.createXDDocument("town");
