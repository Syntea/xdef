...
public class GenComponents2 {
    public static void main(String... args) throws IOException {
        ...
        File components2 = new File("src/task6/components2");
        FUtils.deleteAndCreateDir(components2);
        ...
        System.out.println(
            "XComponents Citizen, City, House, Person and Tenants created to src/task6/components2");

        // 4. save XDPool to the file "src/task6/components2/Town2.xp"
        ObjectOutputStream os = new ObjectOutputStream(new FileOutputStream(new File(components2, "Town2.xp")));
