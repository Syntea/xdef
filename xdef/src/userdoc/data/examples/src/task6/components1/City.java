...
public static class Street implements org.xdef.component.XComponent{
  ...
  public void setName(String x) {_Name=x;}
  public void addHouse(task6.components1.House x) {
    if (x!=null) {
        if (x.xGetXPos()==null)
...
//<editor-fold defaultstate="collapsed" desc="Implementation of XComponent interface">
  private String XD_Name_Name="Name";
  private String _Name;
  private final java.util.List<task6.components1.House> _House=new java.util.ArrayList<>();
  @Override
  public Object toXon() {return org.xdef.component.XComponentUtil.toXon(this);}
  @Override
  public org.w3c.dom.Element toXml()
  ...
  @Override
  public org.xdef.component.XComponent xCreateXChild(org.xdef.proc.XXNode x){return new task6.components1.House(this, x);}
  @Override
  public void xAddXChild(org.xdef.component.XComponent x) {
    x.xSetNodeIndex(XD_ndx++);
    listOfHouse().add((task6.components1.House) x); //A#Town/Street/House
  }
  @Override
  public void xSetAny(org.w3c.dom.Element el) {}
// </editor-fold>
