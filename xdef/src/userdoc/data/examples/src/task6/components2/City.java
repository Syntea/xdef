...
//<editor-fold defaultstate="collapsed" desc="Implementation of XComponent interface">
  ...
  private final java.util.List<City.Street> _Street=new java.util.ArrayList<>();
  @Override
  ...
  public City(org.xdef.component.XComponent p,org.xdef.proc.XXNode x) {
    org.w3c.dom.Element el=x.getElement();
    XD_NodeName=el.getNodeName(); XD_NamespaceURI=el.getNamespaceURI();
    XD_XPos=x.getXPos();
    XD_Model=x.getXMElement().getXDPosition();
    XD_Object = (XD_Parent=p)!=null? p.xGetObject(): null;
    if (!"E7A45004A892E20E4E142EA3C7893159D0D5714C19FE2AEFAB99C969F14E1DA0".equals(
  ...
  @Override
  public org.xdef.component.XComponent xCreateXChild(org.xdef.proc.XXNode x){return new Street(this, x);}
  @Override
  public void xAddXChild(org.xdef.component.XComponent x) {
    x.xSetNodeIndex(XD_ndx++);
    listOfStreet().add((Street) x); //A#Town/Street
  }
  @Override
...
public static class Street implements org.xdef.component.XComponent{
  public String getName() {return _Name;}
  public java.util.List<task6.components2.House> listOfHouse() {
    return _House;
  }
  public void setName(String x) {_Name=x;}
  public void addHouse(task6.components2.House x) {
    if (x!=null) {
        if (x.xGetXPos()==null)
...
//<editor-fold defaultstate="collapsed" desc="Implementation of XComponent interface">
  private String XD_Name_Name="Name";
  private String _Name;
  private final java.util.List<task6.components2.House> _House=new java.util.ArrayList<>();
  @Override
  public Object toXon() {return org.xdef.component.XComponentUtil.toXon(this);}
  @Override
  public org.w3c.dom.Element toXml()
  ...
  public Street(org.xdef.component.XComponent p,org.xdef.proc.XXNode x) {
    ...
    XD_Model=x.getXMElement().getXDPosition();
    XD_Object = (XD_Parent=p)!=null? p.xGetObject(): null;
    if (!"E98B367FD4368AB190F4D1D377E665404B9839568B48EBC11A44C9EB0AE7B29A".equals(
      x.getXMElement().getDigest())) { //incompatible element model
      throw new org.xdef.sys.SRuntimeException(
        org.xdef.msg.XDEF.XDEF374);
    }
  ...
  @Override
  public org.xdef.component.XComponent xCreateXChild(org.xdef.proc.XXNode x){return new task6.components2.House(this, x);}
  @Override
  public void xAddXChild(org.xdef.component.XComponent x) {
    x.xSetNodeIndex(XD_ndx++);
    listOfHouse().add((task6.components2.House) x); //A#Town/Street/House
  }
  @Override
  public void xSetAny(org.w3c.dom.Element el) {}
// </editor-fold>
