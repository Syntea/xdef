...
public class GenSchemaFromXdef {
    ...
    public static void main(final String... args) throws SException {
        ...
        XdefToXsd.main(
            ...
            "-r", "Town", // name of root model in X-definition; use it for XML schema
            "-x", "main"); // name of X-definition

        // 2. check created XML schema with valid XML data
        String xsFile = "task9/output/main.xsd"; // created XML schema
        ...
        if (!s.isEmpty()) { // reported error
            ...
            System.err.println("task9.GenSchemaFromXdef, see task9/errors/schemaErr1.txt");
            return;
        }
